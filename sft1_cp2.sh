...
#export CP_DEBUG_DUMP_DIR="cp_debug_dumps_cp2"
#export CP_A2A=mindspeed
#export CP_A2A=seqalltoall

# export CP_ALIGN_ROUND_PAD=2

mkdir -p logs_cp

USE_V1=1 python -m llamafactory.cli sft examples/v1/train_full/train_full_ulysses_cp_own_cp2.yaml 2>&1 | tee "logs_cp/cp2_$(date +%Y%m%d_%H%M).log"